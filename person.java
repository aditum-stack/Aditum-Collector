...
//
// Debug information:
// Generated date: Sat Jun 08 15:32:08 GMT+08:00 2019
...
public class person extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("id", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        person.this.id = (Long)value;
      }
    });
    setters.put("personnel_id", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        person.this.personnel_id = (String)value;
      }
    });
    setters.put("personnel_name", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        person.this.personnel_name = (String)value;
      }
    });
    setters.put("community_id", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        person.this.community_id = (String)value;
      }
    });
    setters.put("personnel_address", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        person.this.personnel_address = (String)value;
      }
    });
    setters.put("personnel_phone", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        person.this.personnel_phone = (String)value;
      }
    });
    setters.put("create_time", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        person.this.create_time = (java.sql.Timestamp)value;
      }
    });
    setters.put("update_time", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        person.this.update_time = (java.sql.Timestamp)value;
      }
    });
    setters.put("is_deleted", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        person.this.is_deleted = (Boolean)value;
      }
    });
  }
  public person() {
  ...
  public person with_personnel_id(String personnel_id) {
    this.personnel_id = personnel_id;
    return this;
  }
  private String personnel_name;
  public String get_personnel_name() {
    return personnel_name;
  }
  public void set_personnel_name(String personnel_name) {
    this.personnel_name = personnel_name;
  }
  public person with_personnel_name(String personnel_name) {
    this.personnel_name = personnel_name;
    return this;
  }
  ...
  public person with_community_id(String community_id) {
    this.community_id = community_id;
    return this;
  }
  private String personnel_address;
  public String get_personnel_address() {
    return personnel_address;
  }
  public void set_personnel_address(String personnel_address) {
    this.personnel_address = personnel_address;
  }
  public person with_personnel_address(String personnel_address) {
    this.personnel_address = personnel_address;
    return this;
  }
  private String personnel_phone;
  public String get_personnel_phone() {
    return personnel_phone;
  }
  public void set_personnel_phone(String personnel_phone) {
    this.personnel_phone = personnel_phone;
  }
  public person with_personnel_phone(String personnel_phone) {
    this.personnel_phone = personnel_phone;
    return this;
  }
  ...
  public person with_create_time(java.sql.Timestamp create_time) {
    this.create_time = create_time;
    return this;
  }
  ...
  public person with_update_time(java.sql.Timestamp update_time) {
    this.update_time = update_time;
    return this;
  }
  ...
  public person with_is_deleted(Boolean is_deleted) {
    this.is_deleted = is_deleted;
    return this;
  }
  public boolean equals(Object o) {
    ...
    equal = equal && (this.personnel_name == null ? that.personnel_name == null : this.personnel_name.equals(that.personnel_name));
    equal = equal && (this.community_id == null ? that.community_id == null : this.community_id.equals(that.community_id));
    equal = equal && (this.personnel_address == null ? that.personnel_address == null : this.personnel_address.equals(that.personnel_address));
    equal = equal && (this.personnel_phone == null ? that.personnel_phone == null : this.personnel_phone.equals(that.personnel_phone));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.personnel_name = JdbcWritableBridge.readString(3, __dbResults);
    this.community_id = JdbcWritableBridge.readString(4, __dbResults);
    this.personnel_address = JdbcWritableBridge.readString(5, __dbResults);
    this.personnel_phone = JdbcWritableBridge.readString(6, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(personnel_name, 3 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(community_id, 4 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(personnel_address, 5 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(personnel_phone, 6 + __off, 12, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.personnel_name = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
    ...
    if (__dataIn.readBoolean()) { 
        this.personnel_address = null;
    } else {
    this.personnel_address = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.personnel_phone = null;
    } else {
    this.personnel_phone = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.personnel_name) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, personnel_name);
    }
    ...
    if (null == this.personnel_address) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, personnel_address);
    }
    if (null == this.personnel_phone) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, personnel_phone);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(personnel_name==null?"null":personnel_name, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(community_id==null?"null":community_id, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(personnel_address==null?"null":personnel_address, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(personnel_phone==null?"null":personnel_phone, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.personnel_name = null; } else {
      this.personnel_name = __cur_str;
    }
    ...
    if (__cur_str.equals("null")) { this.personnel_address = null; } else {
      this.personnel_address = __cur_str;
    }
    ...
    if (__cur_str.equals("null")) { this.personnel_phone = null; } else {
      this.personnel_phone = __cur_str;
    }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("personnel_name", this.personnel_name);
    __sqoop$field_map.put("community_id", this.community_id);
    __sqoop$field_map.put("personnel_address", this.personnel_address);
    __sqoop$field_map.put("personnel_phone", this.personnel_phone);
